  ...
  return (
    <div className="tickets-container">
      ...
      <div className="tickets__controls">
        ...
        <div className="tickets__view-toggle">
          <button
            className={`tickets__view-btn ${view === "kanban" ? "active" : ""}`}
            onClick={() => setView("kanban")}
          >
            🎯 Kanban
          </button>
          <button
            className={`tickets__view-btn ${view === "list" ? "active" : ""}`}
            ...
            <table className="tickets__table">
              ...
              <tbody>
                {allTickets.map((ticket) => (
                  <tr key={ticket.id}>
                    <td>#{ticket.id}</td>
                    <td className="tickets__title-cell">{ticket.title}</td>
                    <td>
                      <span className="tickets__status-badge">
                        {ticket.status}
                      </span>
                    </td>
                    <td>
                      <span
                        className={`tickets__priority-badge tickets__priority-badge--${ticket.priority}`}
                      >
                        {ticket.priority}
                      </span>
                    </td>
                    ...
                    <td className="tickets__actions-cell">
                      <Link to={`/tickets/${ticket.id}`}>
                        <button className="tickets__action-btn">View</button>
                      </Link>
                      <button
